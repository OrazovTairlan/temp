    ...
    <>
      ...
      >
        <Typography variant="h6" sx={{ p: 1.5 }}>
          Ваши контакты <span>({data.length})</span>
        </Typography>
          ...
          {data.map((contact) => (
            <MenuItem key={contact.id} sx={{ p: 1 }}>
              <Badge
                ...
                sx={{ mr: 2 }}
              >
                <Avatar alt={contact.name} src={"https://kartin.papik.pro/uploads/posts/2023-06/thumbs/1686697218_kartin-papik-pro-p-kartinki-krasivie-kazakhstana-priroda-67.jpg"} />
              </Badge>
