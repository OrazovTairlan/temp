...
import { navData as dashboardNavData, navDataEn } from '../config-nav-dashboard';
...
export function DashboardLayout({ sx, children, data }) {
  ...
  // const navData = i18n.language == 'ru' ? dashboardNavData : (data?.nav ?? dashboardNavData);

  const navData = i18n.language == 'ru' ? dashboardNavData : navDataEn;
