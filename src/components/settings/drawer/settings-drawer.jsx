...
export function SettingsDrawer({
  ...
  const renderPresets = (
    <PresetsOptions
      ...
      options={[
        { name: 'стандартный', value: COLORS.primary.main },
        { name: 'голубой', value: PRIMARY_COLOR.cyan.main },
        { name: 'фиолетовый', value: PRIMARY_COLOR.purple.main },
        { name: 'синий', value: PRIMARY_COLOR.blue.main },
        { name: 'оранжевый', value: PRIMARY_COLOR.orange.main },
        { name: 'красный', value: PRIMARY_COLOR.red.main },
      ]}
    />
  );
