...
export const _fullAddress = [
  `Астана қаласы, Достық көшесі, 18, 164-пәтер / Z05T9M8`,
  `Алматы қаласы, Әл-Фараби даңғылы, 77/8, 819-кеңсе / A05F4Y4`,
  `Шымкент қаласы, Қонаев бульвары, 34, 86-пәтер / 160011`,
  `Астана қаласы, Мәңгілік Ел даңғылы, 55/2, 730-кеңсе / Z05H9E8`,
  `Қарағанды қаласы, Бейбітшілік бульвары, 18, 762-пәтер / 100000`,
  `Ақтөбе қаласы, Әбілқайыр хан даңғылы, 82, 886-кеңсе / 030007`,
  `Алматы қаласы, Абай даңғылы, 109В, 774-пәтер / A05B0F0`,
  `Павлодар қаласы, Сәтбаев көшесі, 104, 591-кеңсе / 140000`,
  `Өскемен қаласы, Тәуелсіздік даңғылы, 98, 573-пәтер / 070004`,
  `Атырау қаласы, Сәтпаев көшесі, 32, 510-кеңсе / 060011`,
  `Астана қаласы, Сарайшық көшесі, 7/1, 183-пәтер / Z05Y7X6`,
  `Алматы қаласы, Желтоқсан көшесі, 115, 673-кеңсе / A05A2A5`,
  `Қостанай қаласы, Тәуелсіздік көшесі, 110, 90-пәтер / 110000`,
  `Астана қаласы, Тұран даңғылы, 50, 1-кеңсе / Z05K9M7`,
  `Ақтау қаласы, 14-ші мөлтек ауданы, 55-үй, 523-пәтер / 130000`,
  `Алматы қаласы, Достық даңғылы, 205, 333-кеңсе / A05D9Y2`,
  `Түркістан қаласы, Б.Саттарханов даңғылы, 25, 821-пәтер / 161200`,
  `Семей қаласы, Шәкәрім көшесі, 101, 606-кеңсе / 071403`,
  `Орал қаласы, Достық-Дружба даңғылы, 202, 703-пәтер / 090000`,
  `Алматы қаласы, Розыбакиев көшесі, 247, 407-кеңсе / A05K8E3`,
  `Астана қаласы, Республика даңғылы, 13, 890-пәтер / Z00M9D1`,
  `Петропавл қаласы, Конституция көшесі, 28, 326-кеңсе / 150000`,
  `Көкшетау қаласы, Абай көшесі, 112, 247-пәтер / 020000`,
  `Талдықорған қаласы, Қабанбай батыр көшесі, 56, 596-кеңсе / 040000`,
];

// ----------------------------------------------------------------------

export const _emails = [
  `askar.akhmetov@mail.kz`,
  `aruzhan_omarova98@gmail.com`,
  `kairat.sultanov@inbox.ru`,
  `madina.serikbay@yandex.kz`,
  `nurlan_bektemirov@hotmail.com`,
  `aigul.isanova85@gmail.com`,
  `berik.zholdas@mail.kz`,
  `saule_torekhan@inbox.ru`,
  `arman.tulegenov@yandex.kz`,
  `zhanar.kadyrova_91@gmail.com`,
  `erbolat.baizhanov@mail.kz`,
  `balnur.ismailova@hotmail.com`,
  `serik.nurpeissov@gmail.com`,
  `gaukhar.abdullina@yandex.kz`,
  `daniyar77@inbox.ru`,
  `aliya.kazbekova@mail.kz`,
  `b.iskakov@gmail.com`,
  `assel_mukanova@yahoo.com`,
  `timur.orazbayev@yandex.kz`,
  `dinara_k@hotmail.com`,
  `m.saparbayev@mail.kz`,
  `zere.sydykova@gmail.com`,
  `galymzhan.nazarov@inbox.ru`,
  `a.nurmagambetova@yandex.kz`,
];
...
export const _postTitles = [
  'Будущее возобновляемой энергии в Казахстане: потенциал солнечной и ветровой энергетики',
  'Влияние искусственного интеллекта на систему здравоохранения Казахстана',
  'Изменение климата и его последствия для продовольственной безопасности Центральной Азии',
  'Рост удаленной работы в Алматы и Астане: преимущества, вызовы и будущие тренды',
  'Цифровой тенге: понимание технологии блокчейн за пределами криптовалют',
  'Психическое здоровье в цифровую эпоху: как соцсети влияют на казахстанцев',
  'Устойчивая мода: как fashion-индустрия Казахстана становится "зеленой"',
  'Космодром Байконур: новые горизонты в исследовании космоса',
  'Эволюция e-commerce: как Kaspi.kz и другие платформы меняют онлайн-торговлю в стране',
  'Кибербезопасность в 21 веке: защита данных в цифровом Казахстане',
  'Роль Big Data в трансформации бизнес-стратегий казахстанских компаний',
  'Возрождение Аральского моря: экологические вызовы и надежды на будущее',
  'Городское фермерство как решение для устойчивого развития мегаполисов Казахстана',
  'Психология потребителя в Казахстане: что движет нашими решениями о покупках?',
  'Развитие туризма в Мангистау: от урочища Бозжыра до Каспийского побережья',
  'Искусственный интеллект в образовании: повышение качества обучения в казахстанских вузах',
  'Влияние изменения климата на внутреннюю и внешнюю миграцию в регионе',
  'Технология 5G в Казахстане: революция в сфере связи и коммуникаций',
  '"Гиг-экономика": возможности и риски для фрилансеров и самозанятых',
  '"Умные города": интеграция технологий для устойчивой городской жизни в Астане',
  'Влияние современной поп-культуры на национальную идентичность молодежи',
  'Инновации в медицине: от телемедицины до персонализированного лечения в РК',
  'Экологическая цена быстрой моды: что могут сделать потребители в Казахстане?',
  'Пересечение искусства и технологий: цифровое искусство и NFT в Центральной Азии',
];
